...
export default function DailyTraffic(props) {
  ...
  const arrowColor = useColorModeValue("green.500", "green.300");
      ...
      <Flex justify="space-between" align="start" px="10px" pt="5px">
        <Flex flexDirection="column" align="start" me="20px">
          ...
          <Flex align="end">
            ...
            <Text ms="6px" color="gray.600" fontSize="sm" fontWeight="500">
              Visitors
            </Text>
          </Flex>
        </Flex>
        <Flex align="center">
          ...
          <Text color={arrowColor} fontSize="sm" fontWeight="700">
            +2.45%
          </Text>
        </Flex>
      </Flex>
